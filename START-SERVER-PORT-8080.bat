...
REM Update .env file to use port 8080
echo ⚙️  Updating configuration to port 8080...
(
...
echo ✅ Configuration updated to port 8080
echo.
...
echo ╚══════════════════════════════════════════════════════════════╝
echo.
echo 🚀 Starting LensLink server on port 8080...
echo.
